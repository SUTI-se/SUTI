...
| 47 | `/xs:schema/xs:complexType[@name='contactInfo']/xs:attribute[@name='contactType']/xs:simpleType/xs:restriction/xs:enumeration[@value='mail']` | `#/$defs/contactInfo/properties/contactType` | narrowed | broaden enum | not-started | none yet |
| 48 | `/xs:schema/xs:complexType[@name='contactInfo']/xs:attribute[@name='contactType']/xs:simpleType/xs:restriction/xs:enumeration[@value='otherInfo']` | `#/$defs/contactInfo/properties/contactType` | narrowed | broaden enum | not-started | none yet |
| 49 | `/xs:schema/xs:complexType[@name='contactInfo']/xs:attribute[@name='contactType']/xs:simpleType/xs:restriction/xs:enumeration[@value='bookingagent']` | `#/$defs/contactInfo/properties/contactType` | narrowed | broaden enum | not-started | none yet |
| 50 | `/xs:schema/xs:complexType[@name='contactInfo']/xs:attribute[@name='contactType']/xs:simpleType/xs:restriction/xs:enumeration[@value='web']` | `#/$defs/contactInfo/properties/contactType` | narrowed | broaden enum | not-started | none yet |
